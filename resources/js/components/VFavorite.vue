<template>
    <button @click="toggleFavorite" class="bg-accent border dark:bg-gray-100 dark:text-gray-700 flex focus:outline-none h-8 items-center md:px-3 px-2 py-1 rounded-xl text-white">
