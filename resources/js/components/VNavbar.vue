<template>
    <div class="card shadow-lg md:px-6">
        ...
        <div class="relative flex items-center justify-between h-16">
          ...
          <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
            <div class="flex-shrink-0 flex items-center">
              <svg viewBox="0 0 316 316" xmlns="http://www.w3.org/2000/svg" class="w-auto h-8 fill-current text-black dark:text-white">
              ...
              <div class="hidden lg:block text-xl text-white font-bold ml-2">
                <a class="text-black uppercase tracking-wider dark:text-white" href="/threads">Forum</a>
              </div>
            </div>
            <!-- @auth -->
              <div v-if="$signIn" class="hidden sm:block sm:ml-6">
                <div class="flex space-x-4">
                  ...
                  <v-dropdown :width="'w-56'" :position="'left-0'">
                    ...
                    <template #menu>
                      <div class="p-1 max-h-80 overflow-y-auto">
                          <a class="dropdown-link" href="/threads">All Threads</a>

                          <a class="dropdown-link" href="/threads?popular=1">Popular Threads</a>

                          <a class="dropdown-link" href="/threads?unanswered=1">Unanswered Threads</a>
                      </div>
                    </template>
                  </v-dropdown>
                </div>
          ...
          <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
            <!-- @guest -->
              <div v-if="!$signIn" class="flex justify-between w-28">
                <a class="text-black text-opacity-60 dark:text-white dark:text-opacity-50 hover:text-black dark:hover:text-white" href="/login">Login</a>

                <a class="text-black text-opacity-60 dark:text-white dark:text-opacity-50 hover:text-black dark:hover:text-white" href="/register">Register</a>
              </div>
            <!-- @else -->
                <div v-else class="flex">
                    ...
                    <a href="/threads/create" class="hidden md:block">
                      <button class="flex btn-accent text-sm ml-3">
                        New Discussion
                      </button>
                    </a>
...
<script>
  ...
  export default {
    components: { VProfileModal, VThemeSwitcher },
    props: ['channels'],
